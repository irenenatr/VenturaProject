...
var FinanceService = function () {
    ...
    var FinanceService = _classThis = /** @class */ (function () {
        function FinanceService_1() {
        }
        FinanceService_1.prototype.addExpense = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, firebase_config_1.db.collection('expenses').add(dto)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, {
        ...
        FinanceService_1.prototype.addBudget = function (dto) {
            return {
                message: 'Budget added',
                data: dto,
            };
        };
        FinanceService_1.prototype.getAll = function () {
            return {
